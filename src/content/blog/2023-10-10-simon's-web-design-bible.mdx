...
tags:
    ...
    - UX
categories: []
lastmod: 2023-10-24T22:42:06.011Z
---
...
Follow these rules and you will probably deliver better web experiences. But don't forget: all rules have exceptions.
...
Around 128 characters is a good limit.

## 6. Don't use overly specific password rules

It's not very secure, but users tend to reuse passwords. That's just how it is until Passkeys are more widely adopted.

When stricter password rules prevent a user from reusing an existing password, they will typiccally...
