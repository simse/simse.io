...
const RadioWindow = (props: RadioWindowProps) => {
  ...
  const play = async () => {
    ...
    await audioElement.play().catch((e) => console.error("Error playing audio:", e));
  };
  ...
  return (
    ...
    >
      <>
        ...
        <div class="mt-2 mb-1 flex items-center justify-between border-b border-black pb-3">
          <div>
          ...
          <button
            type="button"
            class="mr-2 ml-auto flex h-11 w-11 items-center justify-center rounded-sm border border-black hover:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
            onClick={() => {
              if (isPlaying) pause();
              else play();
            }}
          ...
          <button
            type="button"
            class="mt-auto flex h-8 w-8 items-center justify-center rounded-sm border border-black hover:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
            onClick={() => nextSong()}
          >
          ...
          <>
            ...
            <div class="flex flex-col">
              <div class="w-[282px] overflow-hidden">
                <span
                  class={`inline-flex text-2xl leading-5 whitespace-nowrap ${
                    currentlyPlaying.length > 25 ? "animate-os-bounce-marquee" : ""
                  }`}
                  style={{
